...
intrusiondetection = IntrusiondetectionSchema_object()

def save_state():
    json_struct = {}
    json_struct['intrusiondetection'] = intrusiondetection.json_serializer()
...
def load_state():
    ...
    global intrusiondetection
    intrusiondetection = IntrusiondetectionSchema_object(json_struct['intrusiondetection'])
    return True